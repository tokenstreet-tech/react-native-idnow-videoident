...
1. Install `@tokenstreet/react-native-idnow-videoident`:
    ...
    ```sh
    npx expo install @tokenstreet/react-native-idnow-videoident
    ```

    https://github.com/expo/expo/issues/17918

2. Open your app.json and update your plugins section (`expo install` would not do it for you, due to ["expo install skips scoped packages #17918expo install skips scoped packages #17918"](https://github.com/expo/expo/issues/17918):
